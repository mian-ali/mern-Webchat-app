...
function ChatRoomInput({ setChatMessages }) {
  ...
  const handleInputSubmit = (e) => {
    ...
    postUserMessage(
      ...
      (data) => {
        // Update your own room message
        setChatMessages((prev) => [...prev, { ...data.data, avatarImage: user.avatarImage }]);

        // use socket Notify the other party immediately
  ...
  const handleKeyUp = () => {
    // Only if the typing is different emit
  ...
  useEffect(() => {
    if (typingNotify) {
      ...
      console.log('Typing Notify:', typingNotify); // Add this line
